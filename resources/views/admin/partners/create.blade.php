...
@section('content')
    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="/admin/partners/store" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="inputHorizontalSuccess" type="text" name="name" placeholder="Partner Name here"
            ...
            <strong class="text-danger">{{ $errors->first('name') }}</strong>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input id="inputHorizontalSuccess" type="text" name="link" placeholder="website link here"
                                   class="form-control form-control-success">
                            @if ($errors->has('link'))
                                <span class="help-block">

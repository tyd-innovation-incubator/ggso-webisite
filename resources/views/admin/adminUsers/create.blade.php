    ...
    <div class="card-body">
      <form  method="POST" action="/admin/users/store" class="form-horizontal">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input id="inputHorizontalSuccess" type="text" placeholder="Username here"  name="username" class="form-control form-control-success">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input id="inputHorizontalSuccess" type="email" placeholder="Email Address here"  name="email" class="form-control form-control-success">
            @if ($errors->has('email'))
            <span class="help-block">

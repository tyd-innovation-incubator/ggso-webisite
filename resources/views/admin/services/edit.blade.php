...
@section('content')
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="/admin/services/{{ $service->id }}/save" method="POST" enctype="multipart/form-data">
                         {{ csrf_field() }}
                      <div class="form-group row">
                        <label class="col-sm-2">Service Name</label>
                        <div class="col-sm-10">
                          <input id="inputHorizontalSuccess" type="text" value="{{ $service->name }}" name="name"  class="form-control form-control-success">
                           @if ($errors->has('name'))
